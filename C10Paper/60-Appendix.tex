...
Here we discuss separation of 0\nbb-decay events from \Cten~background using 
...
energy of the electrons from 0\nbb-decay. Therefore the amount of scintillation 
light produced at the primary vertex by the positron is smaller than the amount of 
scintillation light produced by electrons in 0\nbb-decay. The scintillation light from 
...
longer times with respect to the 0\nbb-decay events.
...
In the following we assess the separation between 0\nbb-decay and \Cten~events due to the 
...
kinetic energy than kinetic energy of electrons from 0\nbb-decay the amount of early 
PE is smaller for \Cten~events. Delayed 0.718~MeV gamma in some of \Cten~events 
also result in a delay in the photon arrival time with respect to 0\nbb-decay events.

Figure~\ref{fig:Arrival_time_C10_overlaid} compares PE arrival times between 
0\nbb-decay and \Cten~events. To separate the time shift due to smaller kinetic 
...
prompt \Cten~and 0\nbb-decay is caused by presence of a positron and this 
...
As can be seen from Fig.~\ref{fig:Arrival_time_C10_overlaid} there is a noticeable difference
in the shape of PEs arrival time distribution between 0\nbb-decay and \Cten~events. A fit
to a template shapes can be used to discriminate between signal and background. In this study,
to distinguish between 0\nbb-decay and \Cten~events we count total number of PEs in the
early light sample. 
...
Numbers of Cherenkov and scintillation PEs in early light samples for 0\nbb-decay and 
...
Distributions of total number of PEs in the early light sample for 0\nbb-decay and \Cten~events
...
\begin{figure*}[ht]
  ...
  \caption{(Left) Difference between measured PE arrival time and arrival time prediction based on 
	vertex location (T$^{predicted} = |r_{hit} - r_{vtx}|/v_{phot}$, where $v_phot = c/1.53$).
        0\nbb-decay (black solid line) and \Cten~events (magenta dashed line) are compared. 
