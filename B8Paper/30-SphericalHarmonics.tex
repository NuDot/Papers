...
\begin{figure*}[h]
  \centering
%  \begin{tabular}{c c c}
  \includegraphics[width=0.33\textwidth]{hDisplay_topology180_5MeV.pdf}
  \includegraphics[width=0.33\textwidth]{hDisplay_topology90_5MeV.pdf}
  \includegraphics[width=0.33\textwidth]{hDisplay_1el_10MeV.pdf}
%  \end{tabular}
  \includegraphics[width=0.8\textwidth]{hMultipleMoment_CHELight_VtxSmear0cm_VtxShiftX0cm_999p9ns_5p0MeV_center_NoMultScat.pdf}
...
%However, a guess about the event topology still can be made by comparing 
...
In this more realistic example, the uniformly distributed scintillation light makes it more difficult to 
