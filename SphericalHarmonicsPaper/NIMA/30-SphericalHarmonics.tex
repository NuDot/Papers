...
I think bottom panels in Figs.~\ref{fig:ThreeTopologies_Display_5MeV}-\ref{fig:Te130_Display} convey enough info that it only make sense to use
$S_0$ and $S_1$}
...
However, as discussed in Sec.3, ortho-positronium formation is not included in the default Geant-4 package. Therefore, our simulation only 
...
\begin{figure*}[h]
  \centering
  \includegraphics[width=0.45\textwidth]{hEventDisplay_C10_evt_8}
  \includegraphics[width=0.45\textwidth]{hEventDisplay_C10_evt_2}
  \includegraphics[width=0.45\textwidth]{hMultipleMoment_C10_allLight_VtxSmear0cm_VtxShiftX0cm_33p5ns_center}
  \includegraphics[width=0.45\textwidth]{hS0vsS1_Te130_C10_allLight_VtxSmear0cm_VtxShiftX0cm_33p5ns_center}
